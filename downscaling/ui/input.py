...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def knn_set_output_folder(self):
        path = QFileDialog.getExistingDirectory(None, "Select Directory")
        self.ui.knnOutputLineEdit.setText(path)
    ...
    def knn_run(self):
        ...
        out = self.ui.knnOutputLineEdit.text()
        ...
        try:
            ...
            _, _, _, *info = os.path.basename(f).split('_')
            fpath = os.path.join(out, f"knn_scaled_idw_{'_'.join(info)}")
            result.to_csv(fpath)
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_3.addItem(spacerItem6, 0, 0, 1, 3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.knnOutputPathLabel.setText(_translate("MainWindow", "Output Path"))
